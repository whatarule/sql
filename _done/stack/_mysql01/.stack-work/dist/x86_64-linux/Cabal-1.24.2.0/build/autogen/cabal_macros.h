...
/* package mysql-0.1.0.0 */
#define VERSION_mysql "0.1.0.0"
...
/* package io-streams-1.3.6.1 */
#define VERSION_io_streams "1.3.6.1"
#define MIN_VERSION_io_streams(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  3 || \
  (major1) == 1 && (major2) == 3 && (minor) <= 6)

/* package mysql-haskell-0.8.0.0 */
#define VERSION_mysql_haskell "0.8.0.0"
...
#define CURRENT_COMPONENT_ID "mysql-0.1.0.0-8QCq84tVQzh6v4tpiPLHhW"

#define CURRENT_PACKAGE_KEY "mysql-0.1.0.0-8QCq84tVQzh6v4tpiPLHhW"
