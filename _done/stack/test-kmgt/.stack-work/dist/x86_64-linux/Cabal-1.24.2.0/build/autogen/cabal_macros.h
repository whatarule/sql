...
/* package test-kmgt-0.1.0.0 */
#define VERSION_test_kmgt "0.1.0.0"
#define MIN_VERSION_test_kmgt(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package mysql-simple-0.4.0.1 */
#define VERSION_mysql_simple "0.4.0.1"
...
#define CURRENT_COMPONENT_ID "test-kmgt-0.1.0.0-BevTQ9gRptyHovfCTRGnqA"

#define CURRENT_PACKAGE_KEY "test-kmgt-0.1.0.0-BevTQ9gRptyHovfCTRGnqA"
