...
/* package prs-0.1.0.0 */
#define VERSION_prs "0.1.0.0"
#define MIN_VERSION_prs(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "prs-0.1.0.0-IigweT1SdjDLxUHNxCzVZH"

#define CURRENT_PACKAGE_KEY "prs-0.1.0.0-IigweT1SdjDLxUHNxCzVZH"
