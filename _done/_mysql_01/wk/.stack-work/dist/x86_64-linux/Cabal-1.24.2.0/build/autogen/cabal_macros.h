...
/* package wk-0.1.0.0 */
#define VERSION_wk "0.1.0.0"
#define MIN_VERSION_wk(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "wk-0.1.0.0-CDuHbL19oKvLLvGA2qA7mn"

#define CURRENT_PACKAGE_KEY "wk-0.1.0.0-CDuHbL19oKvLLvGA2qA7mn"
